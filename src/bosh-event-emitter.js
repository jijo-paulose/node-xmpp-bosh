...
function BoshEventPipe(host, port, bosh_options, error_handler, bosh_request_processor
	, stat_func) {
	...
	function handle_post_bosh_request(req, res, u) {
		...
		.on('error', function(ex) {
			log_it("WARN", "BEE::Exception '" + ex.toString() + 
